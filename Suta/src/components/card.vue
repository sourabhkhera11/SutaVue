  ...
  <div class="product st-relative lg:st-p-[10px] st-mt-0 st-px-[2px] st-mb-[8px] lg:st-px-[2.5px] lg:st-mb-[17.5px] md:st-mb-[32px] lg:st-basis-[25%] st-basis-[50%]">
    <div class="productcard-img st-relative st-group">
      ...
      <div class="badge st-z-[1] st-absolute st-top-0 st-leading-[23.1px]">
        <span class="st-bg-[#000] st-text-[#fff] st-text-[11px] st-pt-[1.6px] st-pb-[1.6px] st-pl-[8px] st-pr-[8px] st-tracking-[1.98px] st-flex">
      ...
      <a href="/products/jungle-rani" class="product-card__media st-relative st-block">
        <img class="st-cursor-pointer st-block st-w-full" :src="userData.image.src" alt="Jungle Rani">
        
        <img class="st-absolute st-inset-0 st-opacity-0 group-hover:st-opacity-100 st-transition-opacity st-duration-300 st-w-full" src="https://cdn.shopify.com/s/files/1/0026/6544/7536/files/DSC9843_fa27a0ae-c1bc-44b5-af4d-6d69778e2df3_500x.jpg?v=1759212075" alt="2nd image">
      </a>
    </div>
    ...
    <div class="productcardInfo st-py-[4px] st-px-[6px] st-border-[1px] st-border-black/13 st-rounded-bl-[5px] st-rounded-br-[5px] st-border-t-0 st-shadow-[1px_1px_3px_#00000021]">
      <div class="stackcontent st-grid st-grid-rows-3 st-gap-y-[5px]">
        ...
        <a href="" class="st-text-[14px] st-text-center">{{ userData.title }}</a>
        
        <div class="product-type st-flex st-gap-[5px] st-flex-wrap st-justify-center">
        ...
        <div class="prices st-flex st-gap-[15px] st-justify-center">
          <div class="pricetag st-text-[12px] st-line-through st-text-red-600">
            ₹ {{ userData.price }}.00
          </div>
