<template>
  <div class="product st-mt-[20px] md:st-mt-[0px]  md:st-mb-[30px] st-px-[2.5px] md:st-px-[0px]">
    <div class="productcard-img st-relative st-group">
      ...
      <div class="heartButton st-absolute st-right-0 st-z-[2] st-flex st-bg-[#cdc4c4] st-opacity-90 st-border-[1px] st-border-white st-rounded-[50%] st-items-center st-justify-center st-pt-[6px] st-pr-[5px] st-pl-[4px] st-pb-[4px]">
      ...
      <a class="product-card__media st-relaive st-block st-pb-[134%]">
        <img v-if="userData.images[0]" class="st-cursor-pointer st-absolute st-object-contain st-bottom-0 st-block st-w-full" :src="userData.images[0].src" :alt="userData.title">
        ...
        <img v-if="userData.images[1]" class="st-absolute st-object-contain st-bottom-0 st-opacity-0 group-hover:st-opacity-100 st-transition-opacity st-duration-300 st-w-full" :src="userData.images[1].src" :alt="userData.title">
      </a>
      <div v-if="userData.reviews_count" class=" st-flex st-absolute st-bottom-[9px] st-bg-[#fff] st-left-[3px]  st-py-[1px] st-px-[4px] st-text-[12px]"><p>{{ userData.reviews_average.toFixed(1) }}</p>
    ...
    <div v-if="ratio!='sixBysix'" class="productcardInfo st-py-[4px] st-px-[6px]  ">
